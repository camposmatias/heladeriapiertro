document.addEventListener('DOMContentLoaded', () => {
    // Variables
    let baseDeDatos = [
        { id: 1, nombre: 'Manzanas xKg.', precio: 1500, imagen: './img/manzanas.png' },
        { id: 2, nombre: 'Cebolla xKg.', precio: 1200, imagen: './img/cebolla.jpg' },
        { id: 3, nombre: 'Frutilla xKg.', precio: 2100, imagen: './img/frutilla.jpg' },
        { id: 4, nombre: 'Papas xKg.', precio: 1800, imagen: './img/papa.jpg' }
    ];
